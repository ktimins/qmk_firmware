...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   /* NumPad
    * ,-----------------------------------------------------------------------------------.
    * |      |  F13 |  F14 |  F15 |  F16 |  F17 |NUMLCK|  7   |  8   |  9   |  /   |      |
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |      |  F18 |  F19 |  F20 |  F21 |  F22 |      |  4   |  5   |  6   |  *   |      |
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |      |  F23 |  F24 |      |      |      |  0   |  1   |  2   |  3   |  -   |ENTER |
    * |------+------+------+------+------+------+------+------+------+------+------+------|
    * |      |      |      |      |Lower |      +      |Raise |  0   |  .   |POK3R |      |
    * `-----------------------------------------------------------------------------------'
    */
   [_NUMPAD] = LAYOUT_planck_grid(
         _______, KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F17,  KC_NUM,  KC_KP_7, KC_KP_8, KC_KP_9, KC_PSLS, _______,
         _______, KC_F18,  KC_F19,  KC_F20,  KC_F21,  KC_F22,  _______, KC_KP_4, KC_KP_5, KC_KP_6, KC_PAST, _______,
         _______, KC_F23,  KC_F24,  _______, _______, _______, KC_KP_0, KC_KP_1, KC_KP_2, KC_KP_3, KC_PMNS, KC_PENT,
